...
Superb Dispelling {#superb-dispelling .western style="font-weight: normal"}
-----------------
...
| ow .western}                      |                                   |
+-----------------------------------+-----------------------------------+
| Increase spell's saving throw DC  | +2                                |
| by +1                             |                                   |
+-----------------------------------+-----------------------------------+
...
SEED:ANIMATE {#seedanimate .western style="font-weight: normal"}
------------
...
SEED: HEAL {#seed-heal .western style="font-weight: normal"}
----------
...
SEED: LIFE {#seed-life .western style="font-weight: normal"}
----------
...
SEED: REFLECT {#seed-reflect .western style="font-weight: normal"}
-------------
...
SEED: REVEAL {#seed-reveal .western style="font-weight: normal"}
------------
...
SEED: SLAY {#seed-slay .western style="font-weight: normal"}
----------
...
SEED: SUMMON {#seed-summon .western style="font-weight: normal"}
------------
...
SEED: TRANSFORM {#seed-transform .western style="font-weight: normal"}
---------------
...
SEED: TRANSPORT {#seed-transport .western style="font-weight: normal"}
---------------
...
SEED: WARD {#seed-ward .western style="font-weight: normal"}
----------
...
EPIC PSIONIC POWERS {#epic-psionic-powers .western style="font-weight: normal"}
-------------------

The following adjustments should be made if taking psionic characters to
epic levels.

Epic Psionic Seeds {#epic-psionic-seeds .western style="font-weight: normal"}
------------------
...
#####   {#section-3 .western align="center"}

##### Telepathy {#telepathy .western}

#####   {#section-4 .western align="center"}
...
Table: Psionic Factors {#table-psionic-factors .western}
----------------------
...
### Discipline {#discipline .western}

### --5 {#section-5 .western align="center"}

Seed within primary discipline

### Display {#display .western}

###   {#section-6 .western align="center"}

Hide visual display (epic psionic seeds substitute one Vi display for V
and S components)
