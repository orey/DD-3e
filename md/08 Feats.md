...
Operator: asmith
author: AKSmith
changed: '2003-10-24T11:37:00'
created: '2003-04-25T10:14:00'
...
+-----------------------+-----------------------+-----------------------+
| ###### Familiar {#fam | ###### Alignment {#al | ###### Arcane Spellca |
| iliar .western}       | ignment .western}     | ster Level {#arcane-s |
|                       |                       | pellcaster-level .wes |
|                       |                       | tern align="center"}  |
+-----------------------+-----------------------+-----------------------+
...
+-------------------------+-----------------------------------+
| Leader's Reputation     | ### Modifier {#modifier .western} |
+-------------------------+-----------------------------------+
| Great renown            | +2                                |
+-------------------------+-----------------------------------+
...
Leadership Score {#leadership-score .western}
----------------

Cohort Level {#cohort-level .western align="center"}
------------

------ Number of Followers by Level ------ {#number-of-followers-by-level .western align="center"}
------------------------------------------
...
+-----------------+-----------------+-----------------+-----------------+
| Surface {#surfa | Survival DC {#s | Surface Surviva | DC {#dc .wester |
| ce .western}    | urvival-dc .wes | l {#surface-sur | n}              |
| =======         | tern}           | vival .western} | ==              |
|                 | ===========     | =============== |                 |
|                 |                 | =               |                 |
+-----------------+-----------------+-----------------+-----------------+
...
Condition {#condition .western}
=========

Survival DC Modifier {#survival-dc-modifier .western align="center"}
====================
...
1 For a group of mixed sizes, apply only the modifier for the largest
size category.
