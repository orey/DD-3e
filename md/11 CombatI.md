...
Operator: asmith
author: AKSmith
changed: '2003-10-30T11:05:00'
created: '2003-05-05T15:28:00'
generator: 'LibreOffice 6.1.5.2 (Linux)'
title: 'ighty swords clash, arrows hiss through the air, claws'
---

This material is Open Game Content, and is licensed for public use under
the terms of the Open Game License v1.0a.

COMBAT I (BASICS) {#combat-i-basics .western}
-----------------

  {#section .western}
-

HOW COMBAT WORKS {#how-combat-works .western}
----------------
...
Size Modifier {#size-modifier .western}
=============

Size {#size .western align="left"}
====

Size Modifier {#size-modifier-1 .western}
=============
...
ATTACKS OF OPPORTUNITY {#attacks-of-opportunity .western}
----------------------
...
#### Table: Actions in Combat {#table-actions-in-combat .western}
...
#### Action Type Varies {#action-type-varies .western}
...
usually provoke an attack of opportunity. This column indicates whether
the action itself, not moving, provokes an attack of opportunity.

2 If you aid someone performing an action that would normally provoke an
attack of opportunity, then the act of aiding another provokes an attack
of opportunity as well.

3 If the object is being held, carried, or worn by a creature, yes. If
not, no.

4 If you have a base attack bonus of +1 or higher, you can combine one
of these actions with a regular move. If you have the Two- Weapon
Fighting feat, you can draw two light or one-handed weapons in the time
...
### Cast a Spell {#cast-a-spell .western}
...
### Activate Magic Item {#activate-magic-item .western}
...
### Use Special Ability {#use-special-ability .western}
...
### Total Defense {#total-defense .western}
...
### Start/Complete Full-Round Action {#startcomplete-full-round-action .western}
...
### Draw or Sheathe a Weapon {#draw-or-sheathe-a-weapon .western}
...
### Ready or Loose a Shield {#ready-or-loose-a-shield .western}
...
### Manipulate an Item {#manipulate-an-item .western}
...
### Direct or Redirect a Spell {#direct-or-redirect-a-spell .western}
...
### Mount/Dismount a Steed {#mountdismount-a-steed .western}
...
### Full Attack {#full-attack .western}
...
### Cast a Spell {#cast-a-spell-1 .western}
...
### Use Special Ability {#use-special-ability-1 .western}
...
### Move 5 Feet through Difficult Terrain {#move-5-feet-through-difficult-terrain .western}
...
### Drop an Item {#drop-an-item .western}
...
### Cease Concentration on Spell {#cease-concentration-on-spell .western}

You can stop concentrating on an active spell as a free action.

\

### Cast a Quickened Spell {#cast-a-quickened-spell .western}
...
### Take 5-Foot Step {#take-5-foot-step .western}
