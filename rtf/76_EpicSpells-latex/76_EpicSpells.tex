...
\subsection*{\begin{tabular}{|>{\raggedright}p{56pt}|>{\raggedright}p{55pt}|>{\raggedright}p{67pt}|>{\raggedright}p{43pt}|}
\hline
S\textbf{eed}} & B\textbf{ase Spellcraft DC} & S\textbf{eed} & B\textbf{ase Spellcraft 
DC}\tabularnewline
\hline
A\textit{fflict} & 14 & \subsubsection*{E\textit{nergy }} & 19\tabularnewline
\hline
A\textit{nimate } & 25 & F\textit{oresee } & 17\tabularnewline
\hline
A\textit{nimate dead} & 23 & F\textit{ortify } & 17\tabularnewline
\hline
A\textit{rmor } & 14 & H\textit{eal*} & 25\tabularnewline
\hline
B\textit{anish } & 27 & L\textit{ife*} & 27\tabularnewline
\hline
C\textit{ompel } & 19 & R\textit{eflect } & 27\tabularnewline
\hline
C\textit{onceal } & 17 & R\textit{eveal } & 19\tabularnewline
\hline
C\textit{onjure } & 21 & S\textit{lay } & 25\tabularnewline
\hline
C\textit{ontact } & 23 & S\textit{ummon } & 14\tabularnewline
\hline
D\textit{elude } & 14 & T\textit{ransform } & 21\tabularnewline
\hline
D\textit{estroy } & 29 & T\textit{ransport } & 27\tabularnewline
\hline
D\textit{ispel } & 19 & W\textit{ard } & 14\tabularnewline
\hline
\end{tabular}
...
\subsection*{\begin{tabular}{|>{\raggedright}p{260pt}|>{\raggedright}p{61pt}|}
\hline
} & S\textbf{pellcraft DC Modifier}\tabularnewline
\hline
\subsubsection*{C\textit{\textbf{asting Time}}} & \tabularnewline
\hline
Reduce casting time by 1 round (minimum 1 round) & +2\tabularnewline
\hline
1-action casting time & +20\tabularnewline
\hline
Quickened spell (limit one quickened action/round) & +28\tabularnewline
\hline
Contingent on specific trigger\textsuperscript{1} & +25\tabularnewline
\hline
Components No verbal component & +2\tabularnewline
\hline
No somatic component & +2\tabularnewline
\hline
D\textit{\textbf{uration}}\textsuperscript{\textbf{2}} & \tabularnewline
\hline
Increase duration by 100\% & +2\tabularnewline
\hline
Permanent duration (apply this factor after all other epic spell factors but before 
mitigating factors) & x5\tabularnewline
\hline
Dismissible by caster (if not already) & +2\tabularnewline
\hline
Range Increase range by 100\% & +2\tabularnewline
\hline
T\textit{\textbf{arget}}\textsuperscript{\textbf{3}}\textbf{ } & \tabularnewline
\hline
Add extra target within 300 ft. & +10\tabularnewline
\hline
Change from target to area (pick area option below) & +10\tabularnewline
\hline
Change from personal to area (pick area option below) & +15\tabularnewline
\hline
Change from target to touch or ray (300-ft. range) & +4\tabularnewline
\hline
Change from touch or ranged touch attack to target & +4\tabularnewline
\hline
\subsubsection*{A\textit{\textbf{rea}}\textsuperscript{\textbf{4}}} & \tabularnewline
\hline
Change area to bolt (5 ft. x300 ft. or 10 ft. x150 ft.) & +2\tabularnewline
\hline
Change area to cylinder (10-ft. radius,  30 ft. high) & +2\tabularnewline
\hline
Change area to 40-ft. cone & +2\tabularnewline
\hline
Change area to four 10-ft. cubes & +2\tabularnewline
\hline
Change area to 20-ft. radius & +2\tabularnewline
\hline
Change area to target & +4\tabularnewline
\hline
Change area to touch or ray (close range) & +4\tabularnewline
\hline
Increase area by 100\% & +4\tabularnewline
\hline
\subsubsection*{S\textit{\textbf{aving Throw}}} & \tabularnewline
\hline
Increase spell's saving throw DC by +1 & +2\tabularnewline
\hline
\subsubsection*{S\textit{\textbf{pell Resistance}}} & \tabularnewline
\hline
Gain +1 bonus on caster level check to overcome target's spell resistance & +2\tabularnewline
\hline
Gain +1 on caster level check to beat foe's dispel effect & +2\tabularnewline
\hline
\subsubsection*{O\textit{\textbf{ther}}} & \tabularnewline
\hline
Recorded onto stone tablet\textsuperscript{5} & x2\tabularnewline
\hline
Increase damage die by one step (d20 maximum) & +10\tabularnewline
\hline
\end{tabular}
...
\subsection*{\begin{tabular}{|>{\raggedright}p{242pt}|>{\raggedright}p{79pt}|}
\hline
} & S\textbf{pellcraft DC Modifier}\tabularnewline
\hline
Backlash 1d6 points of damage (max d6 = caster's HD x2)\textsuperscript{\textbf{1}}- & 1\tabularnewline
\hline
Burn 100 XP during casting (max 20,000 XP)- & 1\tabularnewline
\hline
Increase casting time by 1 minute (max 10 minutes)\textsuperscript{\textbf{2}}- & 2\tabularnewline
\hline
Increase casting time by 1 day (max 100 days)\textsuperscript{\textbf{2}}- & 2\tabularnewline
\hline
Change from target, touch, or area to personal- & 2\tabularnewline
\hline
Additional participants (ritual) & see Table: Additional Participants in Rituals\tabularnewline
\hline
Decrease damage die by one step (d4 minimum)- & 5\tabularnewline
\hline
\end{tabular}
...
\subsection*{\begin{tabular}{|>{\raggedright}p{60pt}|>{\raggedright}p{51pt}|>{\raggedright}p{60pt}|>{\raggedright}p{51pt}|}
\hline
S\textbf{pell Slot Level Contributed}} & S\textbf{pellcraft DC Reduction } & S\textbf{pell 
Slot Level Contributed} & S\textbf{pellcraft DC Reduction }\tabularnewline
\hline
1st- & 1  & 6th- & 11 \tabularnewline
\hline
2nd- & 3  & 7th- & 13 \tabularnewline
\hline
3rd- & 5  & 8th- & 15 \tabularnewline
\hline
4th- & 7 & 9th- & 17 \tabularnewline
\hline
5th- & 9  & Epic slot- & 19 \tabularnewline
\hline
\end{tabular}
...
\begin{tabular}{|>{\raggedright}p{79pt}|>{\raggedright}p{50pt}|>{\raggedright}p{51pt}|>{\raggedright}p{51pt}|}
\hline
 & B\textbf{ase Psicraft DC} &  & B\textbf{ase Psicraft DC}\tabularnewline
\hline
P\textit{sychometabolism } &  & T\textit{elepathy } & \tabularnewline
\hline
Fortify & 17 & Compel & 19\tabularnewline
\hline
Slay & 25 & Contact & 23\tabularnewline
\hline
Transform & 21 & Delude & 14\tabularnewline
\hline
Heal & 50 & P\textit{sychokinesis } & \tabularnewline
\hline
P\textit{sychoportation } &  & Dispel & 19\tabularnewline
\hline
Banish & 27 & Energy & 19\tabularnewline
\hline
Summon & 14 & Reflect & 27\tabularnewline
\hline
Transport & 27 & Destroy & 29\tabularnewline
\hline
C\textit{lairsentience } &  & Ward & 14\tabularnewline
\hline
Afflict & 14 & M\textit{etacreativity } & \tabularnewline
\hline
Foresee & 17 & Armor & 14\tabularnewline
\hline
Reveal & 19 & Conjure & 21\tabularnewline
\hline
Conceal & 17 & Animate dead & 23\tabularnewline
\hline
\multicolumn{2}{|p{129pt}|}{} & Animate & 25\tabularnewline
\hline
\multicolumn{2}{|p{129pt}|}{} & Life & 55\tabularnewline
\hline
\end{tabular}
...
\subsection*{\begin{tabular}{|>{\raggedright}p{186pt}|>{\raggedright}p{91pt}|}
\hline
} & P\textbf{sicraft DC Modifier}\tabularnewline
\hline
\subsubsection*{D\textit{iscipline }}- & 5\tabularnewline
\hline
Seed within primary discipline & \tabularnewline
\hline
\subsubsection*{D\textit{isplay }} & \tabularnewline
\hline
Hide visual display (epic psionic seeds substitute one Vi display for V and S components) & +4\tabularnewline
\hline
\end{tabular}

\vspace{24pt}
{\LARGE{}NON-EPIC SPELL}
...
\textbf{Effect: }A demiplane coterminous with the Ethereal Plane, centered on your 
location
...
The spellcaster creates a finite plane with limited access: a demiplane. Demiplanes 
created by this power are very small, very minor planes.

A character can only cast this spell while on the Ethereal Plane. When he or she 
casts the spell, a local density fluctuation precipitates the creation of a demiplane. 
At first, the fledgling plane grows at a rate of 1 foot in radius per day to an 
initial maximum radius of 180 feet as it rapidly draws substance from surrounding 
ethereal vapors and protomatter.

The spellcaster determines the environment within the demiplane when he or she 
first casts \textit{genesis, }reflecting most any desire the spellcaster can visualize. 
The spellcaster determines factors such as atmosphere, water, temperature, and 
the general shape of the terrain. This spell cannot create life (including vegetation), 
nor can it create construction (such as buildings, roads, wells, dungeons, and 
so forth). The spellcaster must add these things in some other fashion if he or 
she desires. Once the basic demiplane reaches its maximum size, the spellcaster 
can continue to cast this spell to enlarge the demiplane, adding another 180 feet 
of radius to the demiplane each time.
